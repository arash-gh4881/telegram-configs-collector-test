...
#own
with open("./sub_links/telegram_only.txt", "w", encoding="utf-8") as file:
    telegram_only_configs = array_shadowsocks_channels + array_trojan_channels + array_vmess_channels + array_vless_channels + array_reality_channels
    telegram_only_configs = list(set(telegram_only_configs)) 
    file.write(base64.b64encode("\n".join(telegram_only_configs).encode("utf-8")).decode("utf-8"))